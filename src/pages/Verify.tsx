      ...
      <header className="border-b bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <img src={feuLogo} alt="FEU" className="h-10 w-10" />
        ...
        <div className="max-w-6xl mx-auto px-6 py-10 space-y-8">
          <section className="space-y-3">
            ...
            <p className="text-sm md:text-base text-muted-foreground max-w-2xl">
              These tools are <span className="font-semibold text-emerald-900">public</span> and{" "}
              <span className="font-semibold text-emerald-900">read-only</span>. They let anyone verify integrity
              without logging in — and without revealing ballot choices.
            </p>
          ...
          <section className="grid lg:grid-cols-3 gap-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Enter a Vote ID to open the official auditor verification page. Confirms inclusion in the committed
                    dataset (Merkle-root anchored) without revealing choices.
                  </p>
                </div>
              </div>
            ...
            {/* NFT receipt */}
            <Card className="p-6 rounded-2xl border-2 border-amber-200 hover:border-amber-400 transition">
              <div className="flex items-start gap-3">
            ...
            {/* ZK tally */}
            <Card className="p-6 rounded-2xl border-2 border-slate-200 opacity-90">
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    This will verify that published election results match the on-chain committed votes using a
                    zero-knowledge proof. (Enabled once a tally proof is submitted for an election.)
                  </p>
                </div>
              </div>
              ...
              <div className="mt-5 space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  You’ll use this during defense once the on-chain tally registry is populated.
                </p>
              </div>
            </Card>
          </section>
